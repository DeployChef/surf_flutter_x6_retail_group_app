            ...
            children: [
              Row(
                ...
                children: [
                  Text(
                    "Сортировка",
                    style: theme.textTheme.bodyMedium?.copyWith(fontSize: 20, fontWeight: FontWeight.w700),
                  ),
                  GestureDetector(
                    onTap: () {
              ...
              SortRadio(
                  title: Text(
                    "Без сортировки",
                    style: theme.textTheme.bodyMedium?.copyWith(fontSize: 16, fontWeight: FontWeight.w400),
                  ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    "Готово",
                    style: theme.textTheme.bodyMedium?.copyWith(fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white),
                  ),
                  onPressed: () {
